            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="email" id="email" placeholder="Email"
                        class="bg-gray-100 border-2 p-2 w-full rounded-lg @error('email') border-red-500 @enderror"
                        value="{{ old('email') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" id="password" placeholder="Choose a Password"
                        class="bg-gray-100 border-2 p-2 w-full rounded-lg @error('password') border-red-500 @enderror"
                        value="">
